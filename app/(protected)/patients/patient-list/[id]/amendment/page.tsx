...
export const metadata: Metadata = {
  title: "E-Medical Record / Amendment Patient",
  description: "E-Medical Record / Amendment Patient",
};
  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      <section className="flex flex-col gap-4 px-4 py-6 rounded-md border bg-white">
        <PageHeader
          title="Amendment"
          description="Make amendments to the visit booking"
        />
        <AmendmentForm patientId={id} />
      </section>
    </section>
  );
}
