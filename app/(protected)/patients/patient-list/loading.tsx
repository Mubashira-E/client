...
export default function PatientListLoading() {
  return (
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="flex gap-4 w-full overflow-x-auto">
          ...
          <div className="hidden lg:flex bg-white rounded-md p-4 border flex-1 relative min-w-[300px]">
            <Users className="absolute top-6 right-8 size-14 text-gray-300" strokeWidth={1} />
      ...
      <div className="flex flex-col bg-white rounded-lg">
        ...
        <div className="border rounded-lg">
          ...
          {Array.from({ length: 5 }, (_, rowIndex) => (
            <div key={`patient-table-row-${rowIndex}`} className="border-b last:border-b-0">
