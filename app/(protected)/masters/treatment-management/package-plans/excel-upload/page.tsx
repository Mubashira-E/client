...
export const metadata: Metadata = {
  title: "E-Medical Record / Excel Upload Package Plan",
  description: "E-Medical Record / Excel Upload Package Plan",
};
  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      <section className="flex flex-col gap-4 px-4 py-6 rounded-md border bg-white">
        <PageHeader
          title="Excel Upload"
          description="Upload package master data using a predefined Excel template."
        />
