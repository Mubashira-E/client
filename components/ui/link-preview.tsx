...
export function HoverPeek({
  ...
  // Reset image load state when source changes
  useEffect(() => {
    /* eslint-disable-next-line react-hooks-extra/no-direct-set-state-in-use-effect */
    setImageLoadFailed(false);
  }, [finalImageSrc]);

  // Reset states when peeking stops
  useEffect(() => {
    if (!isPeeking) {
  ...
  // cloneElement is necessary here to add props to the children element
  ...
  /* eslint-enable react/no-clone-element */
